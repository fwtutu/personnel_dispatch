...
from .views import ScheduleCreateView,UserScheduleListView,UserScheduleData
from . import views
...
urlpatterns = [
    ...
    path('schedule/api/UserScheduleData/', views.UserScheduleData, name='UserScheduleData'),
]
